...
returna list of indices off all occurrences of the product if found,or an empty list if the product is not 
found
"""
...
# Example usage:
products = ["shoes","boot","loafer","shoes","santal","shoes"]
target = "shoes"
target2 = 'apple'
